...
var CharacterComponent = function () {
    ...
    var _classThis;
    var CharacterComponent = _classThis = /** @class */ (function () {
        function CharacterComponent_1(route) {
            this.route = route;
            this.backgrounds = [
        ...
        CharacterComponent_1.prototype.ngOnInit = function () {
            var _this = this;
            this.route.params.subscribe(function (params) {
                _this.currentBackground = _this.backgrounds.find(function (background) { return background.name.toLowerCase() === params['character']; });
            });
        };
        return CharacterComponent_1;
    }());
    __setFunctionName(_classThis, "CharacterComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        CharacterComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CharacterComponent = _classThis;
}();
