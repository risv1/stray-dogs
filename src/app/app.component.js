...
var AppComponent = function () {
    var _classDecorators = [(0, core_1.Component)({
            ...
            imports: [router_1.RouterOutlet, panel_component_1.PanelComponent]
        })];
    ...
    var AppComponent = _classThis = /** @class */ (function () {
        function AppComponent_1() {
            this.theme = "../..assets/theme.mp3";
        }
        AppComponent_1.prototype.ngOnInit = function () {
            this.playAudio();
        };
        AppComponent_1.prototype.playAudio = function () {
            this.audio = new Audio();
            this.audio.src = this.theme;
            this.audio.load();
            this.audio.play();
        };
        AppComponent_1.prototype.stopAudio = function () {
            if (this.audio) {
                this.audio.pause();
                this.audio.currentTime = 0;
            }
        };
        AppComponent_1.prototype.playAgain = function () {
            this.playAudio();
        };
