...
var PanelComponent = function () {
    ...
    var _classThis;
    var PanelComponent = _classThis = /** @class */ (function () {
        function PanelComponent_1(router) {
            this.router = router;
            this.characters = [
        ...
        PanelComponent_1.prototype.navToCharacter = function (character) {
            this.router.navigate([character.toLowerCase()]);
        };
        return PanelComponent_1;
    }());
    __setFunctionName(_classThis, "PanelComponent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PanelComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PanelComponent = _classThis;
}();
